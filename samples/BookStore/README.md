...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 998febc9-1266-4cfb-8932-7d406034f4f1
```

> `998febc9-1266-4cfb-8932-7d406034f4f1` is the password of the certificate, you can change it to any password you want.
